...
String intents[] = {"activate", "deactivate", "bring", "increase", "change language", "decrease"}; 
String slots[] = {"socks", "german", "chinese", "lamp", "newspaper", "lights", "music", "korean", "shoes", "english", "kitchen", "bedroom", "washroom", "heat", "volume", "juice", "none"};
...
constexpr int kTensorArenaSize = 1024*46;
...
void setup() {
  ...
  model = tflite::GetModel(checkpoints_2021_08_13_12_30_00_slu_model_tflite);
